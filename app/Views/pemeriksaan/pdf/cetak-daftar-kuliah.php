...
<body class="">
    <div class="w-full mx-auto bg-white p-6 rounded-lg">
        ...
        <p>Telah diperiksa dengan teliti atas permintaannya sendiri dan saat ini yang bersangkutan tidak ada keluhan maka pasien <b>Berbadan Sehat</b> secara fisik, dan sudah dilakukan tes rapid covid-19 dengan hasil non-reaktif.</p><br>
        ...
        <div class="my-4 flex justify-start">
            <div>
                ...
                <span class=""><b>Suhu </b> : <?=$pemeriksaan_objective['suhu']?></span><br>
                <span class=""><b>Nadi</b> : <?=$pemeriksaan_objective['nadi']?></span><br>
                <span class=""><b>RR </b> : <?=$pemeriksaan_objective['respiratory_rate']?></span><br>
            </div>
        </div>
    </div>
</body>
