<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            ...
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="https://flowbite.com" class="flex ms-2 md:me-5">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 me-3" alt="FlowBite Logo" />
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Loket Pendaftaran</span>
                </a>
                <div class="flex items-center">
                    <div>
                        <span class="text-sm text-gray-500 font-bold dark:text-gray-400">Hari : <?=date('D')?></span>
                    </div>
                    <div class="h-8 border-l border-gray-300 mx-4"></div>
                    <div>
                        <span class="text-sm text-gray-500 font-bold dark:text-gray-400"><?=date('Y-m-d H:i:s')?></span>
                    </div>
                </div>
            </div>
            <div class="flex items-center">
                <div class="flex items-center ms-3">
                    ...
                    <ul class="py-1" role="none">
                        <li>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">Profile</a>
                        </li>
                        <li>
