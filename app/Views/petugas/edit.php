...
<div class="p-4 sm:ml-64 h-screen">
    <div class="p-4 mt-14">
        ...
        <form action="<?= base_url('master-data/petugas/edit/update/'. $data->id) ?>" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
				<div class="grid grid-cols-4 gap-3">
                    ...
                    <div class="col-span-2">
						...
						<select id="role" name="role" class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
							...
							<option <?= 'pendaftaran' == set_value("pendaftaran",$data->role) ? "selected" : "" ?> value="pendaftaran">Pendaftaran</option>
							<option <?= 'perawat' == set_value("perawat",$data->role) ? "selected" : "" ?> value="perawat">Perawat</option>
							<option <?= 'dokter' == set_value("dokter",$data->role) ? "selected" : "" ?> value="dokter">Dokter</option>
						</select>
						<div class="text-red-500 text-xs italic font-semibold">
