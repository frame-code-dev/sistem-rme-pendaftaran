...
<div class="p-4 sm:ml-64 h-screen">
    <div class="p-4 mt-14">
        ...
        <div class="card bg-white p-5 mt-4 border rounded-md w-full relative">
            <form action="<?= base_url('kunjungan/create/store/'.$general['id']) ?>" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="border p-3">
                        <div class="bg-blue-800 p-3 mb-4 border rounded-md">
                            <span class="font-semibold text-white uppercase">daftar kunjungan</span>
                        </div>
                        <input type="hidden" name="no_antrian" value="<?= set_value("no_antrian",$no_antrian) ?>">
                        <div class="grid grid-cols-2 gap-3">
                            <div class="col-span-2">
                                <label for="" class="block mb-2 text-sm font-semibold text-gray-900">Jenis Kunjungan<span class="me-2 text-red-500">*</span></label>
                                <select id="jenis_kunjungan" name="jenis_kunjungan" class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option disabled hidden selected value=""> -- Pilih Jenis Kunjungan --</option>
                                    <option <?= 'BARU' == set_value("jenis_kunjungan") ? "selected" : "" ?> value="BARU">BARU</option>
                                    <option <?= 'LAMA' == set_value("jenis_kunjungan") ? "selected" : "" ?> value="LAMA">LAMA</option>
                                </select>
                                <div class="text-red-500 text-xs italic font-semibold">
                                    <?php if (session("errors.jenis_kunjungan")) : ?>
                                        <div class="text-red-500 text-sm">
                                            <?= session("errors.jenis_kunjungan") ?>
                                        </div>
                                    <?php endif ?>
                                </div>
                            </div>
                            <div class="col-span-2">
                                <label for="" class="block mb-2 text-sm font-semibold text-gray-900">Tanggal Kunjungan<span class="me-2 text-red-500">*</span></label>
                                <input type="date" placeholder="Masukkan Tanggal" name="tanggal_kunjungan" id="tanggal_kunjungan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                            ...
                            <div class="col-span-2">
                                <label for="" class="block mb-2 text-sm font-semibold text-gray-900">POLI TUJUAN<span class="me-2 text-red-500">*</span></label>
                                <select id="poli_tujuan" name="poli_tujuan" class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option <?= 'POLI UMUM' == set_value("poli_tujuan") ? "selected" : "" ?> selected value="POLI UMUM">POLI UMUM</option>
                                </select>
                                <div class="text-red-500 text-xs italic font-semibold">
                                    <?php if (session("errors.poli_tujuan")) : ?>
                                        <div class="text-red-500 text-sm">
                                            <?= session("errors.poli_tujuan") ?>
                                        </div>
                                    <?php endif ?>
                                </div>
                            </div>
                            <div class="col-span-2">
                                ...
                                <select id="cara_bayar" name="cara_bayar" class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    ...
                                    <option <?= 'BPJS' == set_value("cara_bayar") ? "selected" : "" ?> value="BPJS">BPJS</option>
                                    <option <?= 'UMUM' == set_value("cara_bayar") ? "selected" : "" ?> value="UMUM">UMUM</option>
                                </select>
                                <div class="text-red-500 text-xs italic font-semibold">
                                    <?php if (session("errors.cara_bayar")) : ?>
                                        <div class="text-red-500 text-sm">
                                            <?= session("errors.cara_bayar") ?>
                                        </div>
                                    <?php endif ?>
                                </div>
                            </div>
