...
<?=$this->section('js')?>
    ...
    <script>
        $('#status_lainnya').on("change",function() {
            let jenis = $(this).val();
            console.log(jenis);
            if (jenis == "kitas") {
                ...
                $('#nomor_identitas_paspor').removeClass("hidden");
    ...
    <div class="p-4 sm:ml-64 h-screen">
        <div class="p-4 mt-14">
            ...
            <div class="card bg-white p-5 mt-4 border rounded-md w-full relative">
            	<form action="<?= base_url('pendaftaran/store') ?>" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="jenis_pasien" name="jenis_pasien" class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        ...
                                        <option <?= 'BPJS' == set_value("BPJS") ? "selected" : "" ?> value="BPJS">BPJS</option>
                                        <option <?= 'UMUM' == set_value("UMUM") ? "selected" : "" ?> value="UMUM">UMUM</option>
                                    </select>
                                    <div class="text-red-500 text-xs italic font-semibold">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="jenis_kelamin" name="jenis_kelamin" class="select2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option disabled hidden selected value=""> -- Pilih Jenis Pasien --</option>
                                        <option <?= 'L' == set_value("L") ? "selected" : "" ?> value="L">Laki-Laki</option>
                                        <option <?= 'P' == set_value("P") ? "selected" : "" ?> value="P">Perempuan</option>
                                    </select>
                                    <div class="text-red-500 text-xs italic font-semibold">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="pendidikan" name="pendidikan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="0" <?= set_value('pendidikan') == '0' ? 'selected' : '0' ?>> -- Pilih Pendidikan -- </option>
                                        <option value="TK" <?= set_value('pendidikan') == 'TK' ? 'selected' : 'TK' ?>> TK</option>
                                        <option value="SD" <?= set_value('pendidikan') == 'SD' ? 'selected' : 'SD'?>>  SD</option>
                                        <option value="SMP" <?= set_value('pendidikan') == 'SMP' ? 'selected' : 'SMP'?>>  SMP</option>
                                        <option value="SMA" <?= set_value('pendidikan') == 'SMA' ? 'selected' : 'SMA'?>>  SMA</option>
                                        <option value="D1" <?= set_value('pendidikan') == 'D1' ? 'selected' : 'D1'?>>  D1</option>
                                        <option value="D2" <?= set_value('pendidikan') == 'D2' ? 'selected' : 'D2'?>>  D2</option>
                                        <option value="D3" <?= set_value('pendidikan') == 'D3' ? 'selected' : 'D3'?>>  D3</option>
                                        <option value="D4" <?= set_value('pendidikan') == 'D4' ? 'selected' : 'D4'?>>  D4</option>
                                        <option value="S1" <?= set_value('pendidikan') == 'S1' ? 'selected' : 'S1'?>>  S1</option>
                                        <option value="S2" <?= set_value('pendidikan') == 'S2' ? 'selected' : 'S2'?>>  S2</option>
                                        <option value="S3" <?= set_value('pendidikan') == 'S3' ? 'selected' : 'S3'?>>  S3</option>
                                    </select>
                                    <div class="text-red-500 text-xs italic font-semibold">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="pekerjaan" name="pekerjaan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="0" <?= set_value('pekerjaan') == '0' ? 'selected' : '' ?>>Pilih Status</option>
                                        <option value="PNS/TNI-POLRI" <?= set_value('pekerjaan') == 'PNS/TNI-POLRI' ? 'selected' : ''?>>PNS/TNI-POLRI</option>
                                        <option value="Swasta" <?= set_value('pekerjaan') == 'Swasta' ? 'selected' : ''?>>Swasta</option>
                                        <option value="Wiraswasta" <?= set_value('pekerjaan') == 'Wiraswasta' ? 'selected' : ''?>>Wiraswasta</option>
                                        <option value="Petani" <?= set_value('pekerjaan') == 'Petani' ? 'selected' : ''?>>Petani</option>
                                        <option value="Buruh" <?= set_value('pekerjaan') == 'Buruh' ? 'selected' : ''?>>Buruh</option>
                                        <option value="Ibu Rumah Tangga" <?= set_value('pekerjaan') == 'Ibu Rumah Tangga' ? 'selected' : ''?>>Ibu Rumah Tangga</option>
                                        <option value="Pelajar" <?= set_value('pekerjaan') == 'Pelajar' ? 'selected' : ''?>>Pelajar</option>
                                        <option value="Tidak Bekerja" <?= set_value('pekerjaan') == 'Tidak Bekerja' ? 'selected' : ''?>>Tidak Bekerja</option>
                                    </select>
                                    <div class="text-red-500 text-xs italic font-semibold">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="status_kawin" name="status_kawin" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="0" <?= set_value('status_nasabah') == '0' ? 'selected' : '' ?>> -- Pilih Status -- </option>
                                        <option value="1" <?= set_value('status_nasabah') == '1' ? 'selected' : ''?>> Belum Menikah</option>
                                        <option value="2" <?= set_value('status_nasabah') == '2' ? 'selected' : ''?>> Menikah</option>
                                        <option value="3" <?= set_value('status_nasabah') == '3' ? 'selected' : ''?>> Duda</option>
                                        <option value="4" <?= set_value('status_nasabah') == '4' ? 'selected' : ''?>> Janda</option>
                                    </select>
                                    <div class="text-red-500 text-xs italic font-semibold">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="status_lainnya" name="status_lainnya" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option value="0" <?= set_value('status_lainnya') == '0' ? 'selected' : '' ?>> -- Pilih Status -- </option>
                                        <option value="kitas" <?= set_value('status_lainnya') == 'kitas' ? 'selected' : ''?>> KITAS</option>
                                        <option value="paspor" <?= set_value('status_lainnya') == 'paspor' ? 'selected' : ''?>> PASPOR</option>
                                    </select>
                                    <div class="text-red-500 text-xs italic font-semibold">
                                ...
                                <div class="col-span-2" id="content_nomor_identitas">
                                    <div id="content_nomor_identitas_kitas" class="hidden">
                                        ...
                                        <input type="text" placeholder="Masukkan Nomor Identitas KIS" maxlength="11" name="nomor_identitas_kitas" id="nomor_identitas_kitas" class="nomor_identitas_kitas bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                                            value="<?= set_value("nomor_identitas_kitas") ?>">
                                        <div class="text-red-500 text-xs italic font-semibold">
                                    ...
                                    <div id="content_nomor_identitas_paspor" class="hidden">
                                        ...
                                        <input type="text" placeholder="Masukkan Nomor Identitas PASPOR" name="nomor_identitas_paspor" id="nomor_identitas_paspor" class="nomor_identitas_paspor bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                                            value="<?= set_value("nomor_identitas_paspor") ?>">
                                        <div class="text-red-500 text-xs italic font-semibold">
                    ...
                    <div class="flex justify-end align-middle content-center bg-gray-100 p-3 rounded-md">
                        ...
                        <div>
                            <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="submit">Simpan Data Dan Lanjutkan ke General Consent</button>
                        </div>
