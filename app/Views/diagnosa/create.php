...
<div class="p-4 sm:ml-64 h-screen">
    <div class="p-4 mt-14">
        ...
        <div class="card bg-white p-5 mt-4 border rounded-md w-full relative">
        	<form action="<?= base_url('master-data/diagnosa/store') ?>" method="POST" class="w-full mx-auto space-y-4" enctype="multipart/form-data">
